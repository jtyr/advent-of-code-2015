...
def add(d, include_red=True):
    ...
    if isinstance(d, list):
        ...
        if include_red or "red" not in d.values():
...
def main():
    ...
    print "[Star 1] Sum of all numbers is: %d" % add(data)
    print(
        "[Star 2] Sum of all numbers without red dicts is: %d" %
        add(data, False))
