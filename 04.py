...
def find_number(length, my_input):
    n = 1

    while md5.new("%s%d" % (my_input, n)).hexdigest()[0:length] != "0"*length:
        sys.stdout.write("%s\r" % n)
...
def main():
    ...
    print "\r[Star 1] Number: %d" % find_number(5, my_input)
    print "\r[Star 2] Number: %d" % find_number(6, my_input)
